...
print(f"✅ DataFrame criado: {len(df_teste)} registros, {len(df_teste.columns)} colunas")
print(df_teste.head())
print()
...
try:
    ...
    print(f"✅ Excel criado com sucesso: {caminho_excel}")
...
try:
    ...
    print(f"✅ CSV criado com sucesso: {caminho_csv}")
...
try:
    ...
    print(f"✅ JSON criado com sucesso: {caminho_json}")
...
try:
    ...
    print(f"✅ PDF criado com sucesso: {caminho_pdf}")
...
try:
    ...
    print(f"✅ PDF com gráfico criado com sucesso: {caminho_pdf_completo}")
    tamanho = os.path.getsize(caminho_pdf_completo) / 1024
    print(f"   Tamanho: {tamanho:.2f} KB")
except Exception as e:
    print(f"❌ Erro na exportação PDF com gráfico: {e}")
...
try:
    ...
    print("✅ Aliases funcionam corretamente!")
except Exception as e:
...
for arquivo in sorted(arquivos):
    ...
    print(f"   📁 {arquivo:30s} {tamanho:8.2f} KB")

print()
print("=" * 60)
print("✅ TODOS OS TESTES DE EXPORTAÇÃO FORAM CONCLUÍDOS!")
print("=" * 60)
